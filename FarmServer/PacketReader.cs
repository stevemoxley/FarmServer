...
namespace FarmServer
{
    public class PacketReader
    {
        ...
        public ulong ReadULong()
        {
            ...
            return (ulong)((m_Data[m_Index++] << 56) | (m_Data[m_Index++] << 48) | (m_Data[m_Index++] << 40) | (m_Data[m_Index++] << 32) | (m_Data[m_Index++] << 24) | (m_Data[m_Index++] << 16) | (m_Data[m_Index++] << 8) | m_Data[m_Index++]);
        }
