...
namespace FarmServer
{
    ...
    public class PacketWriter
    {
        ...
        {
            byte[] m_Buff = new byte[8];
            m_Buff[0] = (byte)(value >> 56);
            m_Buff[1] = (byte)(value >> 48);
            m_Buff[2] = (byte)(value >> 40);
            m_Buff[3] = (byte)(value >> 32);
            m_Buff[4] = (byte)(value >> 24);
            m_Buff[5] = (byte)(value >> 16);
            m_Buff[6] = (byte)(value >> 8);
            m_Buff[7] = (byte)value;

            m_Stream.Write(m_Buff, 0, 8);
        }
